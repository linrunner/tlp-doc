...
project = 'TLP'
copyright = '2022, linrunner. Licensed under the CC BY-NC-SA'
author = 'Thomas Koch'
...
html_context = {
    'css_files': [
        ...
        '_static/lineblock.css',   # remove line-block bottom margin
...
latex_documents = [
    (master_doc, 'TLP.tex', 'TLP Documentation',
     'Thomas Koch', 'manual'),
]
...
man_pages = [
    (master_doc, 'tlp', 'TLP Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'TLP', 'TLP Documentation',
     author, 'TLP', 'One line description of project.',
     'Miscellaneous'),
]
