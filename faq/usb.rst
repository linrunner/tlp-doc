...
The second line shows an input device that is disabled by default in TLP. The third line shows
a bluetooth adapter that is disabled due to `USB_EXCLUDE_BTUSB=1`. 
